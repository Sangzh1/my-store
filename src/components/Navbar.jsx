    ...
    <div className="navbar bg-base-100 py-5 shadow-lg ">
      <div className="max-container flex justify-between">
        <div className="">
          <Link
            to="/"
            className="btn btn-secondary btn-sm text-xs md:btn-md md:text-xl"
          >
            My-Store
          </Link>
        </div>
        <div className="flex items-center gap-3">
          <label className="swap swap-rotate">
            ...
            {/* sun icon */}
            <svg
              className="swap-on m-5 h-5 fill-current md:h-7 md:w-7"
            ...
            {/* moon icon */}
            <svg
              className="swap-off m-5 h-5 fill-current md:h-7 md:w-7"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
          ...
          <p className="bg-light-blue-600 text-xs md:text-xl">
            {" "}
